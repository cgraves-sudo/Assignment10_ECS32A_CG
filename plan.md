...
Important: If your repository is public, do not commit .streamlit/secrets.toml to version control. Add it to your .gitignore and provide the file only in your final assignment submission.
...
The diagram below shows the expected layout your app should match. All elements must appear in the correct locations.
